// Name: More Events Rus
// ID: lmsMoreEventsRus
// Description: Start your scripts in Russian.
// By: Goshan_2021 <https://scratch.mit.edu/users/Goshan_2021/>
...
(function (Scratch) {
  ...
  const validKeyboardInputs = [
    // Special Inputs
    { text: "пробел", value: "space" },
    { text: "стрелка вверх", value: "up arrow" },
    { text: "стрелка вниз", value: "down arrow" },
    { text: "стрелка вправо", value: "right arrow" },
    { text: "стрелка влево", value: "left arrow" },
    { text: "enter", value: "enter" },
    // TW: Extra Special Inputs
    { text: "задний пробел", value: "backspace" },
    { text: "удалить", value: "delete" },
    { text: "шифт", value: "shift" },
    { text: "капс", value: "caps lock" },
    { text: "скролл лок", value: "scroll lock" },
    { text: "контрл", value: "control" },
    { text: "эскейп", value: "escape" },
    { text: "инсерт", value: "insert" },
    { text: "хом", value: "home" },
    { text: "энд", value: "end" },
    { text: "пейдж вверх", value: "page up" },
    { text: "пейдж вниз", value: "page down" },
      ...
      return {
        ...
        blocks: [
...

          {
            ...
            text: "когда [CONDITION] будет [STATE]",
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.HAT,
            text: "когда [CONDITION] это [STATE]",
            isEdgeActivated: false,
            arguments: {
              CONDITION: {
                type: Scratch.ArgumentType.BOOLEAN,
...

          {
            ...
            blockType: Scratch.BlockType.HAT,
            text: "когда [KEY_OPTION] кнопка [ACTION]",
            isEdgeActivated: true,
            arguments: {
              KEY_OPTION: {
                type: Scratch.ArgumentType.STRING,
...

          {
            ...
            text: "сообщение [BROADCAST_OPTION] к [TARGET]",
            arguments: {
              BROADCAST_OPTION: {
                type: null,
              },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "сообщение [BROADCAST_OPTION] к [TARGET] и ждать",
            arguments: {
              BROADCAST_OPTION: {
                type: null,
              },
...

          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "сообщение [BROADCAST_OPTION] с данными [DATA]",
            arguments: {
              BROADCAST_OPTION: {
                type: null,
              },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "сообщение [BROADCAST_OPTION] с данными [DATA] и ждать",
            arguments: {
              BROADCAST_OPTION: {
                type: null,
              },
...

          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "сообщение [BROADCAST_OPTION] к [TARGET] с данными [DATA]",
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "сообщение [BROADCAST_OPTION] к [TARGET] с данными [DATA] и ждать",
